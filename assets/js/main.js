        ...
        var swiperHero = new Swiper('.mySwiper', {
            ...
            on: {
                ...
                slideChangeTransitionEnd: function () {
                    // Trigger animation for active slide
                    $('.swiper-slide-active .slide-content').css({
   ...
   //client-testimonial start
    $(function () {
        ...
        function initSwiper() {
            ...
            // Check if the required elements exist (excluding .mySwiper to avoid conflict with hero carousel)
            if ($(".mySwiperDesktop").length || $(".mySwiper2").length) {
                if ($(window).width() > 768) {
                    ...
                    // Initialize Swiper for mobile (excluding .mySwiper to avoid conflict)
                    galleryTop = new Swiper(".mySwiperDesktop", {
                        spaceBetween: 10,
                        slidesPerView: 9,
                        freeMode: false,
